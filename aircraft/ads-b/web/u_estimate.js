d3.csv("./data.csv").then(function(data){
  ...
  svg.append("g")
    ...
    .call(d3
      .axisBottom(x.domain([-300,300]))
      .tickValues(d3.range(-300,301,50))
  ...
  svg.append("g")
  .call(d3
    .axisTop(x.domain([-300,300]))
    .tickValues(d3.range(-300,301,50))
    .tickFormat(''))
  //y axis
  svg.append("g")
    .call(d3
      .axisLeft(y.domain([-300,300]))
      .tickValues(d3.range(-300,301,50))
  ...
  svg.append("g")
    ...
    .call(d3
      .axisRight(y.domain([-300,300]))
      .tickValues(d3.range(-300,301,50))
      .tickFormat(''))

  svg.selectAll("circle")
    .data(d3.range(400,49,-50))
    .enter()
    .append("circle")
    .attr("fill","none")
    .attr("stroke","black")
